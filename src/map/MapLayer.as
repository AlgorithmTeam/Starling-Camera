    ...
    public class MapLayer extends Sprite implements ICameraLayer
    {
        ...
        public function MapLayer( drawPlanets:Boolean, drawStars:Boolean, rows:int = 0, cols:int = 0 )
        {
            ...
            // grid
             if ( rows != 0 && cols != 0 )
             {
                 shape.graphics.lineStyle( 1.0, 0xffffff, 0.2 );
             ...
             {
                 shape.graphics.moveTo( -w * 0.5, -h * 0.5 + r * tileH );
                 shape.graphics.lineTo( -w * 0.5 + cols * tileW, -h * 0.5 + r * tileH );
             }

             // cols
             for ( var c:int = 0; c <= cols; c++ )
             {
                 shape.graphics.moveTo( -w * 0.5 + c * tileW, -h * 0.5 );
                 shape.graphics.lineTo( -w * 0.5 + c * tileW, -h * 0.5 + rows * tileH );
             }
             }
             ...
             {
                 shape.graphics.lineStyle( 2.0, 0x000066 );
                 shape.graphics.beginFill( 0x7f7fff );
                 shape.graphics.drawCircle( -w * 0.5 + Math.random() * w, -h * 0.5 + Math.random() * h, 25 + Math.random() * 30 );
             ...
             for ( var s:int = 0; s < numStars; s++ )
             {
                 ...
                 shape.graphics.drawCircle( -w * 0.5 + Math.random() * w, -h * 0.5 + Math.random() * h, 2 + Math.random() * 4 );
                 shape.graphics.endFill();
             }
             }
